<x-auth-split-layout>
    ...
    {{-- SSO / OAuth Buttons — only shown when configured --}}
    @php
        $googleEnabled = !empty(\App\Models\Setting::get('oauth_google_client_id'));
        $microsoftEnabled = !empty(\App\Models\Setting::get('oauth_microsoft_client_id'));
    @endphp
    ...
    @if($googleEnabled || $microsoftEnabled)
        ...
        <div class="relative mt-8">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-white dark:bg-gray-800 px-4 text-gray-500 dark:text-gray-400">Or sign in with</span>
            </div>
        </div>
        ...
        <div class="mt-6 space-y-3">
            @if($microsoftEnabled)
                <a href="{{ route('social.redirect', 'microsoft') }}"
                   class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5" viewBox="0 0 23 23" fill="none"><path fill="#f35325" d="M1 1h10v10H1z"/><path fill="#81bc06" d="M12 1h10v10H12z"/><path fill="#05a6f0" d="M1 12h10v10H1z"/><path fill="#ffba08" d="M12 12h10v10H12z"/></svg>
